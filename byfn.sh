...
# NOTE TO SELF: THIS SCRIPT CONTAINS COMMANDS i CAN RUN ON THE COMMAND LINE
# i USE THIS SCRIPT AS A REFERENCE WITH EXAMPLES AND COMMENTS

# NOTE: commands in here are generally stored in the ../first-network/bin dir.
# That bin directory can be put into the $PATH, or, the files can be copied
# to where you want to run command(s) before you run them.
